                            ...
                            case 2: //Gps定位包
                               ...
                               // console.log(datas)
                                ...
                                marker.on('click', function (e) {
                                    ...
                                    content += '<button type="button" id="track" class="layui-btn layui-btn-fluid info-btn">轨迹回放</button>';
                                    // content += '<button type="button" id="dispatch" class="layui-btn layui-btn-fluid info-btn">车辆调度</button>';
