...
! function(e) {
	...
	o.prototype.cache = n, o.prototype.define = function(e, t) {
		...
		function c(e, t) {
			...
			("load" === e.type || o.test((e.currentTarget || e.srcElement).readyState)) && (n.modules[d] = t, y.removeChild(h),
				function r() {
		...
		return u.rel = "stylesheet", u.href = e + (n.debug ? "?v=" + (new Date).getTime() : ""), u.media = "all", t.getElementById(
			s) || l.appendChild(u), "function" != typeof o ? i : (function f() {
		...
		return "LAYUI-EVENT-REMOVE" === o ? (delete(a.cache.event[l] || {})[c], a) : r ? (n.event[l] = n.event[l] || {}, n.event[
			l][c] = [r], this) : (layui.each(n.event[l], function(e, t) {
